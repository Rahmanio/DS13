...
/**
 * tgui state: tg_hands_state
 *
 * Checks that the src_object is in the user's hands.
 */

GLOBAL_DATUM_INIT(tg_hands_state, /datum/ui_state/tg_hands_state, new)

/datum/ui_state/tg_hands_state/can_use_topic(src_object, mob/user)
